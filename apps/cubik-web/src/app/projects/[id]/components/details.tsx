"use client";
import { useDisclosure } from "@/utils/chakra";
import { Box, Container, HStack, VStack } from "@/utils/chakra";
import {
  Drawer,
  DrawerBody,
  DrawerCloseButton,
...
import { Contribution, Project, Round, Team, User } from "@cubik/database";
  ...
  return (
    ...
    >
      <Header
        ...
        short_description={projectDetails?.shortDescription as string}
      />
      {/* {hackathonId && (
        <MobileOnlyViews
          name={name}
